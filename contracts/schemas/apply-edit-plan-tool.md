...
- `normalize` may omit measured peak or loudness inputs in the request. The runtime can fill those at execution time while still recording the explicit resolved parameters in the emitted `TransformRecord`.
