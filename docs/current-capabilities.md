...
- benchmark coverage is fixture-backed for the current cleanup slice, but the end-to-end request-cycle corpus is still intentionally small and focused on stable tonal cleanup, restoration, and loudness/control prompts plus clarification/failure controls
